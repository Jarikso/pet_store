    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(db_index=True, max_length=50, verbose_name='полное имя')),
                ('avatar', models.ImageField(blank=True, upload_to='img_profile/', verbose_name='изображение')),
